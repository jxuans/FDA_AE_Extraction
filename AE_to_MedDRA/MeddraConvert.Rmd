...
for (file_path in excel_files) {
  ...
  if (grepl("\\.xlsx$", file_path, ignore.case = TRUE)) {
    ...
    next  # Skip files that are neither .xlsx nor .csv
  }
  
  # Print file being processed (for debugging)
  cat("Processing file:", file_path, "\n")
  
  # Further operations on 'data' can be added here
  data$llt_code <- NA
  data$pt_code <- NA
...
```{r}
query <- "SELECT llt_name, llt_code, pt_code FROM llt_table WHERE llt_name ILIKE  'Cardiac and Arterial Vascular Occlusive Events';"
